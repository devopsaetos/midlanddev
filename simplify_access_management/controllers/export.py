...
from odoo.addons.simplify_access_management.models.query_prepare import search_data
...
class Export(Export):
    ...
    def get_fields(self, model, domain, prefix='', parent_name='',
        ...
        invisible_field_ids = search_data(self, 'hide.field', request.params.get('model'), ('invisible','=',True), 'AND')
