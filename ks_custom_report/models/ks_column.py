...
class KsCrColumn(models.Model):
    ...
    def write(self, values):
        ...
        field = self.env['ir.model.fields'].search(
            [('id', '=', self.ks_cr_field_id.id), ('model_id', '=', self.ks_cr_model_id.ks_cr_model_id.id)])
        if values.get('name'):
            field.field_description = values['name']
    ...
    def create(self, vals_list):
        ...
        recs = super(KsCrColumn, self).create(vals_list)
        return recs
