...
""",
    ...
    'data': [
        ...
        'data/ks_aggregate_function.xml',
        'data/ks_default_data.xml',
        'data/ks_mail_cron.xml',
        'data/dn_data.xml',
        'data/sequence.xml',
        'data/ks_number_format_data.xml',
        'data/ks_date_filter_data.xml',
        ...
        'views/ks_item_source_view.xml',
        'views/ks_date_filter_view.xml',
        'views/ks_item_formatting_models.xml',
        'data/dashboard.xml',
    ],
    ...
    'assets': {
        'ks_dashboard_ninja.ks_dashboard_lib': [
            ...
            'ks_dashboard_ninja/static/lib/amcharts/exporting/*',
        ],
        'web.assets_backend': [
