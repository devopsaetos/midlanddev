...
import { KsItem } from '../ks_dashboard_items/ks_item';
...
export class KsItems extends Component {
    ...
    static components = { DNTile, DNTodo, DNKpi, DNGraph, KsItem }
    static props = {
        itemsBasicData: {
            type: Array,
        },
    ...
    componentInfo(itemBasicData){
        return {
            component: KsItem,
            props: {
                data: { sources: [], model_data: itemBasicData },
                dashboardData: this.props.dashboardData,
                toDisable: {
                    lazyDataFetching: false, itemPopover: !this.props.dashboardData.ks_dashboard_manager
                },
                filters: {}
            }
        };
    ...
    triggerFetching(detail){
        ...
        for(let itemBasicData of this.props.itemsBasicData){
            ...
            if(itemBasicData.is_new_dn) continue
