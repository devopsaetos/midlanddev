...
from odoo.addons.ks_dashboard_ninja.common_lib.ks_utils import replace_company_domain
...
class KsDashboardNinjaBoard(models.Model):
    ...
    def ks_fetch_dashboard_configs(self, ks_item_domain=[]):
        ...
        item_basic_data_fields = ['id', 'ks_dashboard_item_type', 'ks_model_name_2', 'ks_model_name', 'is_new_dn', 'type']
        configs = {
