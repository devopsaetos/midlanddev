...
class BookingAllotmentPlan(models.Model):
    ...
    def _invoice_id_data(self):
        for rec in self:
            ...
            # elsewhere instead. Without this guard, any unrelated write
            # re-triggering this compute would blank amount_paid/residual
            # back to 0 even on a genuinely paid line.
            if rec.invoice_id:
